...
execute .
TWOSTEP CLUSTER
  /CATEGORICAL VARIABLES=country  variety
  ...
  /VIEWMODEL DISPLAY=YES EVALUATIONFIELDS=designation province region_1 taster_twitter_handle taster_name  title  winery 
